  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error: err } = await supabase
      ...
      .update({
        ...
        valor_parcelas: form.valor_parcelas
          ? Number(form.valor_parcelas)
          : null,
        valor_intercaladas: form.valor_intercaladas
          ? Number(form.valor_intercaladas)
          : null,
  ...
  return (
    <div>
      <div style={{ marginBottom: "1.5rem" }}>
        ...
        >
          {(form.empreendimentos as any)?.nome} — Unidade{" "}
          {(form.unidades as any)?.unidade}
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          >
            <div>
              <label style={S.label}>Nome do comprador</label>
              {inp("comprador_nome")}
            </div>
            <div>
              <label style={S.label}>CPF/CNPJ</label>
              {inp("comprador_documento")}
            </div>
            <div>
            ...
            <div>
              <label style={S.label}>Comissão (R$)</label>
              {inp("comissao", "number")}
            </div>
            <div>
        ...
        >
          ...
          >
            <div>
              <label style={S.label}>Valor da venda (R$)</label>
              {inp("valor_venda", "number")}
            </div>
            <div>
            ...
            <div>
              <label style={S.label}>Valor das parcelas (R$)</label>
              {inp("valor_parcelas", "number")}
            </div>
            <div>
              <label style={S.label}>Valor intercaladas (R$)</label>
              {inp("valor_intercaladas", "number")}
            </div>
            <div>
              <label style={S.label}>Valor das chaves (R$)</label>

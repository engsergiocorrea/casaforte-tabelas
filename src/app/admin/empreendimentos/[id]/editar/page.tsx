        ...
        >
          ...
          >
            ...
            <div style={{ gridColumn: "1/-1" }}>
              ...
              {inp("imagem_capa_url", "url", "https://")}
            </div>
            <div style={{ gridColumn: "1/-1" }}>
              <label style={S.label}>Logo do empreendimento (URL)</label>
              {inp("logo_url", "url", "https://")}
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div>
              ...
              {sel("indice_apos_entrega", [
                { value: "1_mais_igpm", label: "1% + IGP-M" },
                { value: "1_mais_ipca", label: "1% + IPCA" },
                { value: "IPCA", label: "IPCA" },
                { value: "IGP-M", label: "IGP-M" },
                { value: "outro", label: "Outro" },
              ])}
            ...
            <div>
              ...
              <input
                ...
                type="number"
                value={form.percentual_sinal_padrao ?? ""}
                onChange={handleChange}
                style={{
                  width: "100%",
                  padding: "8px 12px",
            ...
            <div>
              ...
              <input
                name="percentual_chaves_padrao"
                type="number"
                value={form.percentual_chaves_padrao ?? ""}
                onChange={handleChange}
                style={{
                  width: "100%",
                  padding: "8px 12px",
            ...
            <div>
              <label style={S.label}>Data prevista entrega</label>
            ...
            <div>
              ...
              >
                <input
                  type="checkbox"
                  name="ativo_publico"
                  checked={form.ativo_publico ?? false}
                  onChange={handleChange}
                  style={{
                    width: "16px",
                    height: "16px",

            ...
            <tbody>
              {clientes.map((cli: Cliente) => (
                <tr key={cli.id} style={{ borderBottom: '1px solid #f3f4f6' }}>
                  ...
                  <td style={{ padding: '10px 14px' }}>
                    <Link href={'/admin/clientes/' + cli.id} style={{ padding: '3px 10px', border: '1px solid #e5e7eb', borderRadius: '6px', fontSize: '12px', color: '#374151', textDecoration: 'none' }}>Ver</Link>
                  </td>
                </tr>
              ))}
            </tbody>

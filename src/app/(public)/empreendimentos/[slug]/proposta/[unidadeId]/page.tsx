...
export default function PropostaPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Dispara WhatsApp em background sem bloquear
    fetch('/api/whatsapp', {
      method: 'POST',
    ...
    }).then(r => r.json()).then(j => console.log('[WhatsApp]', j)).catch(e => console.error('[WhatsApp]', e))
  }
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) setError('WhatsApp erro: ' + JSON.stringify(json))
    } catch (e: any) {
      console.error('[WhatsApp]', e)
      setError('WhatsApp erro: ' + e.message)
    }

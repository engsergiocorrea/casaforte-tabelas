    ...
    <Page size="A4" orientation="landscape" style={styles.page}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          {empreendimento.cidade}, {empreendimento.estado} · Atualizado em {new Date().toLocaleDateString('pt-BR')}
        </Text>
      </View>
      <View>
      ...
      <Text style={styles.footer}>
        Os valores e condições podem sofrer alteração sem aviso prévio. Casa Forte Construtora e Incorporadora.
      </Text>
    </Page>
  </Document>
)

  ...
  return NextResponse.json({
    proposta: {
      ...
      comprador_principal: {
        ...
        cep: p.comprador1_cep ?? null,
        endereco: p.comprador1_endereco ?? null,
        nacionalidade: p.comprador1_nacionalidade ?? null,
        naturalidade: p.comprador1_naturalidade ?? null,
      },
      comprador_adicional: {
        ...
        cep: p.comprador2_cep ?? null,
        endereco: p.comprador2_endereco ?? null,
        nacionalidade: p.comprador2_nacionalidade ?? null,
        naturalidade: p.comprador2_naturalidade ?? null,
      },
      conjuge: {
        ...
        cep: p.conjuge_cep ?? null,
        endereco: p.conjuge_endereco ?? null,
        nacionalidade: p.conjuge_nacionalidade ?? null,
        naturalidade: p.conjuge_naturalidade ?? null,
      },
      corretor: {
      ...
      pagamento: {
        ...
        mensais_primeira_data: p.data_primeira_parcela ?? null,
